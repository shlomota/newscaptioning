...
from fields.image_field import ImageField
from fields.list_text_field import ListTextField
...
@DatasetReader.register('BM_reader')
class BMReader(DatasetReader):
    ...
    def article_to_instance(self, paragraphs, paragraphs_scores, named_entities, image, caption,
        ...
        fields = {
            ...
            'labels': LabelField(paragraphs_scores)
        }
